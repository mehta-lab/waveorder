...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.cb_acq_channel, self.chb_phase_from_bf)
        Form.setTabOrder(self.chb_phase_from_bf, self.le_save_dir)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_orientation_offset.setText(_translate("Form", "90 Degree Offset  "))
