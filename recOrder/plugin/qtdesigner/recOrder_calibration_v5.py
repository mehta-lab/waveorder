...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 493, 1173))
        ...
        self.qbutton_stop_calibrate = QtWidgets.QPushButton(self.run_calib)
        self.qbutton_stop_calibrate.setObjectName("qbutton_stop_calibrate")
        self.verticalLayout_2.addWidget(self.qbutton_stop_calibrate)
    ...
    def retranslateUi(self, Form):
        ...
        self.qbutton_stop_calibrate.setText(_translate("Form", "Stop Calibration"))
