...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.qbutton_capture_bg, self.scrollArea_5)
        Form.setTabOrder(self.scrollArea_5, self.te_log)
        Form.setTabOrder(self.te_log, self.le_n_avg)
        ...
        Form.setTabOrder(self.qbutton_stop_reconstruct, self.scrollArea_2)
