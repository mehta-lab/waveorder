...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.te_log, self.scrollArea_4)
        Form.setTabOrder(self.scrollArea_4, self.qbutton_acq_birefringence)
        ...
        Form.setTabOrder(self.cb_acq_channel, self.le_overlay_slice)
        Form.setTabOrder(self.le_overlay_slice, self.chb_pause_updates)
        Form.setTabOrder(self.chb_pause_updates, self.tabWidget_3)
        Form.setTabOrder(self.tabWidget_3, self.le_data_dir)
        Form.setTabOrder(self.le_data_dir, self.qbutton_browse_data_dir)
        Form.setTabOrder(self.qbutton_browse_data_dir, self.le_save_dir)
        ...
        Form.setTabOrder(self.le_calibration_metadata, self.qbutton_browse_calib_meta)
        Form.setTabOrder(self.qbutton_browse_calib_meta, self.cb_bg_method)
        ...
        Form.setTabOrder(self.le_mag, self.qbutton_load_default_config)
        ...
        Form.setTabOrder(self.qbutton_save_config, self.le_notes_field)
        Form.setTabOrder(self.le_notes_field, self.cb_method)
        ...
        Form.setTabOrder(self.le_focus_zidx, self.le_pad_z)
        Form.setTabOrder(self.le_pad_z, self.le_bf_chan)
        ...
        Form.setTabOrder(self.le_itr, self.qbutton_reconstruct)
        Form.setTabOrder(self.qbutton_reconstruct, self.qbutton_stop_reconstruct)
        Form.setTabOrder(self.qbutton_stop_reconstruct, self.le_sat_min)
        Form.setTabOrder(self.le_sat_min, self.le_sat_max)
        Form.setTabOrder(self.le_sat_max, self.qbutton_push_note)
        Form.setTabOrder(self.qbutton_push_note, self.cb_hue)
        Form.setTabOrder(self.cb_hue, self.le_val_min)
        Form.setTabOrder(self.le_val_min, self.scrollArea_5)
        Form.setTabOrder(self.scrollArea_5, self.cb_saturation)
        Form.setTabOrder(self.cb_saturation, self.le_val_max)
        Form.setTabOrder(self.le_val_max, self.cb_value)
        Form.setTabOrder(self.cb_value, self.cb_colormap)
        Form.setTabOrder(self.cb_colormap, self.chb_display_volume)
        Form.setTabOrder(self.chb_display_volume, self.slider_saturation)
        Form.setTabOrder(self.slider_saturation, self.slider_value)
        Form.setTabOrder(self.slider_value, self.qbutton_create_overlay)
