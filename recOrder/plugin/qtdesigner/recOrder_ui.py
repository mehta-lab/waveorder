...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 590, 1051))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        Form.setTabOrder(self.le_overlay_slice, self.le_notes_field)
        Form.setTabOrder(self.le_notes_field, self.cb_phase_denoiser)
        ...
        Form.setTabOrder(self.le_itr, self.le_sat_min)
