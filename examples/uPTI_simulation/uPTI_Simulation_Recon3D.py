...
file_name = '/data_sm/home/lihao/project/Polscope/Simulation/3D_Pol_Phase/uPTI_repo_demo/uPTI_simulation_data_NA_det_147_NA_illu_140_2D_spoke_discrete_no_1528_ne_1553_no_noise_Born.npz'
...
wo.plot_multicolumn(f_tensor[...,L//2], num_col=4, origin='lower', size=5,
...
wo.plot_multicolumn(np.stack([phase_PT[...,L//2], retardance_pr_PT[0,:,:,L//2], azimuth[0,:,:,L//2], theta[0,:,:,L//2], \
                                             absorption_PT[...,L//2], retardance_pr_PT[1,:,:,L//2], azimuth[1,:,:,L//2], theta[1,:,:,L//2]]),
