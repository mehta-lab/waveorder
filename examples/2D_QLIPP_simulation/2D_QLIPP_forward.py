...
# #### Save simulation
output_file = '/data_sm/home/lihao/project/Polscope/Simulation/3D_Pol_Phase/uPTI_repo_demo/2D_QLIPP_simulation'
np.savez(output_file, I_meas=I_meas_noise, Stokes_out=Stokes_out, lambda_illu=lambda_illu,                       n_media=n_media, NA_obj=NA_obj, NA_illu=NA_illu, ps=ps, Source_cont=Source_cont,                       z_defocus=z_defocus, chi=chi)
