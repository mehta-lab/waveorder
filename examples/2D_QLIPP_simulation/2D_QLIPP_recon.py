...
file_name = '/data_sm/home/lihao/project/Polscope/Simulation/3D_Pol_Phase/uPTI_repo_demo/2D_QLIPP_simulation.npz'
...
wo.plot_multicolumn(np.array([Recon_para[0,:,:,L//2], Recon_para[1,:,:,L//2], Recon_para[2,:,:,L//2], Recon_para[3,:,:,L//2]]),
                    num_col=2, size=5, set_title=True,
                    titles=['Retardance', '2D orientation', 'Brightfield', 'Depolarization'], origin='lower')

wo.plot_hsv([Recon_para[1,:,:,L//2], Recon_para[0,:,:,L//2]],max_val=1, origin='lower', size=10)
plt.show()
...
wo.plot_multicolumn(np.array([retardance, azimuth]), num_col=2, size=10,
...
wo.plot_multicolumn(np.array([retardance_TV, azimuth_TV]), num_col=2, size=10,
                    set_title=True, titles = ['Reconstructed retardance', 'Reconstructed orientation'], origin='lower')
