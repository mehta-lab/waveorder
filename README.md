...
![Data_flow](./readme.svg)
<!-- TODO: Update to a direct link to github before release. Replace (./readme.svg) with (https://github.com/mehta-lab/waveorder/blob/main/readme.svg?raw=true)-->
#
