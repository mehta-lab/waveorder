...
def test_pinhole_aperture_otf_small_diameter():
    ...
    small_pinhole_otf = isotropic_fluorescent_thick_3d._calculate_pinhole_aperture_otf(
        radial_frequencies, pinhole_diameter=0.1
    )

    # Large pinhole should give narrow OTF (lower mean, more concentrated)
    large_pinhole_otf = isotropic_fluorescent_thick_3d._calculate_pinhole_aperture_otf(
...
def test_calculate_transfer_function():
    z_padding = 5
    transfer_function = isotropic_fluorescent_thick_3d.calculate_transfer_function(
...
def test_confocal_otf_extended_support():
    ...
    # Widefield OTF
    otf_widefield = isotropic_fluorescent_thick_3d.calculate_transfer_function(**params, confocal_pinhole_diameter=None)

    # Confocal OTF with small pinhole
    otf_confocal = isotropic_fluorescent_thick_3d.calculate_transfer_function(**params, confocal_pinhole_diameter=0.5)
...
def test_apply_inverse_transfer_function():
    ...
    result_tikhonov = isotropic_fluorescent_thick_3d.apply_inverse_transfer_function(
        zyx_data,
