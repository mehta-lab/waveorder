...
def test_stokes_matrix_write(
    birefringence_phase_recon_settings_function, make_czyx
):
...
def test_fluorescence_2d_write(
    fluorescence_recon_settings_function, make_czyx
):
