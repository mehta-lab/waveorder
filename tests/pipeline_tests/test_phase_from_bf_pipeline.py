...
def test_3D_reconstruction(setup_BF_test_data_zarr, setup_data_save_folder):
    ...
    phase3D = reconstruct_qlipp_phase3D(np.transpose(data[t, 0], (1, 2, 0)), recon, method=config.phase_denoiser_3D,
...
def test_2D_reconstruction(setup_BF_test_data_zarr, setup_data_save_folder):
    ...
    phase2D = reconstruct_qlipp_phase2D(np.transpose(data[t, 0], (1, 2, 0)), recon, method=config.phase_denoiser_2D,
